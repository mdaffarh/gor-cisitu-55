    ...
    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-body col-xl-8">
                <h3 class="mt-4 mb-4 fw-bold mx-2" style="color: var(--navy)">Edit Data Member</h3>
                <form action="/dashboard/membership/{{ $membership->id_membership }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            name="nama_member"
                            value="{{ old('nama_member') ? old('nama_member') : $membership->nama_member }}">
                        @error('nama_member')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            name="no_telp_member"
                            value="{{ old('no_telp_member') ? old('no_telp_member') : $membership->no_telp_member }}">
