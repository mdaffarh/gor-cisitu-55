    ...
    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-body col-xl-8">
                ...
                <form action="/dashboard/fasilitas/{{ $fasilitas->id_lapangan }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            name="nama_lapangan"
                            value="{{ old('nama_lapangan') ? old('nama_lapangan') : $fasilitas->nama_lapangan }}">
                        @error('nama_lapangan')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            name="harga_lapangan"
                            value="{{ old('harga_lapangan') ? old('harga_lapangan') : $fasilitas->harga_lapangan }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            name="harga_tournament"
                            value="{{ old('harga_tournament') ? old('harga_tournament') : $fasilitas->harga_tournament }}">
