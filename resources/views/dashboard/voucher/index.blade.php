...
@section('container')
    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-body">
                <!-- Form Add Start-->
                <h3 class="mt-4 mb-4 fw-bold mx-2" style="color: var(--navy)">Tabel Voucher</h3>
                <div class="d-flex flex-row-reverse">

                    <a href="/dashboard/voucher/create" type="button" class="btn btn-success"">
                        Tambah Data
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($voucher as $v)
                                <tr>
                                    ...
                                    <td>{{ $v->nilai_voucher }}</td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            {{-- Update Button --}}
                                            <a href="/dashboard/voucher/{{ $v->id_voucher }}/edit"
                                            ...
                                            <button type="button" class="btn btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#delete{{ $v->id_voucher }}">
                                ...
                                {{-- Modal Delete --}}
                                <div class="modal fade" id="delete{{ $v->id_voucher }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5 fw-bold" style="color: var(--navy);"
                                                    id="deleteLabel">Hapus Data Voucher</h1>
                                            ...
                                            <div class="modal-footer">
                                                <form action="/dashboard/voucher/{{ $v->id_voucher }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
