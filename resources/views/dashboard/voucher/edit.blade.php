    ...
    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-body col-xl-8">
                <h3 class="mt-4 mb-4 fw-bold mx-2" style="color: var(--navy)">Edit Data Voucher</h3>
                <form action="/dashboard/voucher/{{ $voucher->id_voucher }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            name="jenis_voucher"
                            value="{{ old('jenis_voucher') ? old('jenis_voucher') : $voucher->jenis_voucher }}">
                        @error('jenis_voucher')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number"
                            ...
                            name="nilai_voucher"
                            value="{{ old('nilai_voucher') ? old('nilai_voucher') : $voucher->nilai_voucher }}">
                        @error('nilai_voucher')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
